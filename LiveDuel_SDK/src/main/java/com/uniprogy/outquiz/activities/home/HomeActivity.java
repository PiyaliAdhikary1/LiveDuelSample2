...
public class HomeActivity extends BaseActivity {
    ...
    public static int backgroundImageID=0;
    //endregion
    ...
    private void configureView()
    {
        ...
        bcg_home = (ImageView)findViewById(R.id.bcg_home);
        ...
        if(iconID!=0 && backgroundImageID!=0){
            icon.setImageResource(iconID);
            bcg_home.setImageResource(backgroundImageID);
        }
    }
        ...
        public void success(JSONObject response) {
            ...
            if(obj != null)
            {
                try {
                    ...
                    if(live == 1)
                    {
                        show.socket = obj.getString("socket");
                        show.streaming = obj.getString("streaming");
                    }
    ...
    private void launchShow()
    {
        ...
        i.putExtra("socket", show.socket);
        i.putExtra("streaming", show.streaming);
        startActivity(i);
